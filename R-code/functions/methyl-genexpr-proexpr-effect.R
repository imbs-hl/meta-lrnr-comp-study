...
methyl_genexpr_proexpr_effect <- function(n = 100L,
  ...
  effect_df <- data.frame(
    delta.methyl = c(methyl_strong, methyl_strong, methyl_moderate, methyl_low),
    delta.expr = c(genexpr_strong, genexpr_moderate, genexpr_low, genexpr_low),
    delta.protein = c(proexpr_moderate, proexpr_low, proexpr_low, genexpr_low),
