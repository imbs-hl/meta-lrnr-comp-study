...
## na_action = na_keep
## -----------------------------------------------------------------------------
reg_me_indep_missbalanced_na_keep <- wrap_batchtools(reg_name = "02-train-cobra-na-keep",
...
## ----------------------------------------------
##
reg_indep_missbalanced_me_cobra_na_keep <- batchtools::loadRegistry(
  file.dir = file.path(reg_indep_missbalanced_me, "02-train-cobra-na-keep"),
  writeable = TRUE,
  conf.file = config_file)
reg_indep_missbalanced_me_cobra_na_keep <- batchtools::reduceResultsList(
  ids = batchtools::findDone(
    ids = 1:nrow(indep_missbalanced_me_param_data),
    reg = reg_indep_missbalanced_me_cobra_na_keep
  ),
  reg = reg_indep_missbalanced_me_cobra_na_keep)
...
## na_action = na_impute
## -----------------------------------------------------------------------------
reg_me_indep_missbalanced_na_impute <- wrap_batchtools(reg_name = "02-train-cobra-na-imp",
                                                       work_dir = working_dir,
                                                       reg_dir = reg_indep_missbalanced_me,
                                                       r_function = single_run_cobra,
                                                       vec_args = data.frame(
...
## ----------------------------------------------
##
reg_indep_missbalanced_me_cobra_na_impute <- batchtools::loadRegistry(
  file.dir = file.path(reg_indep_missbalanced_me, "02-train-cobra-na-imp"),
  writeable = TRUE,
  conf.file = config_file)
reg_indep_missbalanced_me_cobra_na_impute <- batchtools::reduceResultsList(
  ids = batchtools::findDone(
    ids = 1:nrow(indep_missbalanced_me_param_data),
    reg = reg_indep_missbalanced_me_cobra_na_impute
  ),
  reg = reg_indep_missbalanced_me_cobra_na_impute)


## resume filtered results
res_indep_missbalanced_me_cobra_na_impute <- data.table::rbindlist(reg_indep_missbalanced_me_cobra_na_impute)
res_indep_missbalanced_me_mean_perf_cobra_na_impute <- res_indep_missbalanced_me_cobra_na_impute[ , .(mean_perf = mean(meta_layer)), 
                                                                                              by = .(perf_measure, effect)]
print(res_indep_missbalanced_me_mean_perf_cobra_na_impute)
res_indep_missbalanced_me_mean_perf_cobra_na_impute$Setting <- "Independent"
res_indep_missbalanced_me_mean_perf_cobra_na_impute$Y_Distribution <- "Balanced"
res_indep_missbalanced_me_mean_perf_cobra_na_impute$Na_action <- "na.impute"
res_indep_missbalanced_me_mean_perf_cobra_na_impute$DE <- "DE: Me"
res_indep_missbalanced_me_mean_perf_cobra_na_impute$Meta_learner <- "COBRA"
saveRDS(
  object = res_indep_missbalanced_me_mean_perf_cobra_na_impute,
  file = file.path(res_indep_me,
