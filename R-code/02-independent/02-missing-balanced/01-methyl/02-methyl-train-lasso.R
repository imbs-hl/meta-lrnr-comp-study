...
## -----------------------------------------------------------------------------
##
reg_me_indep_missbalanced_na_impute <- wrap_batchtools(reg_name = "02-train-lasso-na-imp",
...
reg_indep_missbalanced_me_lasso_na_impute <- batchtools::reduceResultsList(
  ids = batchtools::findDone(
    ...
    reg = reg_indep_missbalanced_me_lasso_na_impute
  ),
  reg = reg_indep_missbalanced_me_lasso_na_impute)


## resume filtered results
res_indep_missbalanced_me_lasso_na_impute <- data.table::rbindlist(reg_indep_missbalanced_me_lasso_na_impute)
res_indep_missbalanced_me_mean_perf_lasso_na_impute <- res_indep_missbalanced_me_lasso_na_impute[ , .(mean_perf = mean(meta_layer)), 
