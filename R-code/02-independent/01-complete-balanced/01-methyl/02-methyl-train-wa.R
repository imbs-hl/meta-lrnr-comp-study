...
res_indep_combalanced_me_mean_perf_wa_na_keep$Meta_learner <- "Weighted average"
saveRDS(
...
## na_action = na_impute
## -----------------------------------------------------------------------------
reg_me_indep_combalanced_na_impute <- wrap_batchtools(reg_name = "02-train-wa-na-imp",
                                                       work_dir = working_dir,
                                                       reg_dir = reg_indep_combalanced_me,
                                                       r_function = single_run_wa,
                                                       vec_args = data.frame(
