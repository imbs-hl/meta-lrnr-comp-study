...
## na_action = na_keep
## -----------------------------------------------------------------------------
reg_me_indep_combalanced_na_keep <- wrap_batchtools(reg_name = "02-train-wa-na-keep",
...
## ----------------------------------------------
##
reg_indep_combalanced_me_wa_na_keep <- batchtools::loadRegistry(
  file.dir = file.path(reg_indep_combalanced_me, "02-train-wa-na-keep"),
  writeable = TRUE,
  conf.file = config_file)
reg_indep_combalanced_me_wa_na_keep <- batchtools::reduceResultsList(
  ids = batchtools::findDone(
    ids = 1:nrow(indep_combalanced_me_param_data),
    reg = reg_indep_combalanced_me_wa_na_keep
  ),
  reg = reg_indep_combalanced_me_wa_na_keep)
...
res_indep_combalanced_me_mean_pewa_wa_na_keep <- res_indep_combalanced_me_wa_na_keep[ , .(mean_pewa = mean(meta_layer)), 
                                                                                        by = .(perf_measure, effect)]
print(res_indep_combalanced_me_mean_perf_wa_na_keep)
res_indep_combalanced_me_mean_perf_wa_na_keep$Setting <- "Independent"
res_indep_combalanced_me_mean_perf_wa_na_keep$Y_Distribution <- "Balanced"
res_indep_combalanced_me_mean_perf_wa_na_keep$Na_action <- "na.keep"
res_indep_combalanced_me_mean_perf_wa_na_keep$DE <- "DE: Me"
res_indep_combalanced_me_mean_perf_wa_na_keep$Meta_learner <- "BM"
saveRDS(
  object = res_indep_combalanced_me_mean_perf_wa_na_keep,
...
reg_indep_combalanced_me_wa_na_impute <- batchtools::reduceResultsList(
  ids = batchtools::findDone(
    ids = 1:nrow(indep_combalanced_me_param_data),
    reg = reg_indep_combalanced_me_wa_na_impute
  ),
  reg = reg_indep_combalanced_me_wa_na_impute)


## resume filtered results
res_indep_combalanced_me_wa_na_impute <- data.table::rbindlist(reg_indep_combalanced_me_wa_na_impute)
res_indep_combalanced_me_mean_perf_wa_na_impute <- res_indep_combalanced_me_wa_na_impute[ , .(mean_perf = mean(meta_layer)), 
                                                                                            by = .(perf_measure, effect)]
print(res_indep_combalanced_me_mean_perf_wa_na_impute)
res_indep_combalanced_me_mean_perf_wa_na_impute$Setting <- "Independent"
...
saveRDS(
  ...
  file = file.path(res_indep_me,
                   "res_indep_combalanced_me_mean_perf_wa_na_impute.rds")
)
