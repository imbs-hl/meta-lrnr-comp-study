...
## na_action = na_keep
## -----------------------------------------------------------------------------
reg_me_indep_combalanced_na_keep <- wrap_batchtools(reg_name = "02-train-cobra-na-keep",
...
## ----------------------------------------------
##
reg_indep_combalanced_me_cobra_na_keep <- batchtools::loadRegistry(
  file.dir = file.path(reg_indep_combalanced_me, "02-train-cobra-na-keep"),
  writeable = TRUE,
  conf.file = config_file)
reg_indep_combalanced_me_cobra_na_keep <- batchtools::reduceResultsList(
  ids = batchtools::findDone(
    ids = 1:nrow(indep_combalanced_me_param_data),
    reg = reg_indep_combalanced_me_cobra_na_keep
  ),
  reg = reg_indep_combalanced_me_cobra_na_keep)


## resume filtered results
res_indep_combalanced_me_cobra_na_keep <- data.table::rbindlist(reg_indep_combalanced_me_cobra_na_keep)
res_indep_combalanced_me_mean_perf_cobra_na_keep <- res_indep_combalanced_me_cobra_na_keep[ , .(mean_perf = mean(meta_layer)), 
                                                                                              by = .(perf_measure, effect)]
print(res_indep_combalanced_me_mean_perf_cobra_na_keep)
res_indep_combalanced_me_mean_perf_cobra_na_keep$Setting <- "Independent"
...
## na_action = na_impute
## -----------------------------------------------------------------------------
reg_me_indep_combalanced_na_impute <- wrap_batchtools(reg_name = "02-train-cobra-na-imp",
                                                       work_dir = working_dir,
                                                       reg_dir = reg_indep_combalanced_me,
                                                       r_function = single_run_cobra,
                                                       vec_args = data.frame(
...
reg_indep_combalanced_me_cobra_na_impute <- batchtools::reduceResultsList(
  ids = batchtools::findDone(
    ids = 1:nrow(indep_combalanced_me_param_data),
    reg = reg_indep_combalanced_me_cobra_na_impute
  ),
  reg = reg_indep_combalanced_me_cobra_na_impute)


## resume filtered results
res_indep_combalanced_me_cobra_na_impute <- data.table::rbindlist(reg_indep_combalanced_me_cobra_na_impute)
res_indep_combalanced_me_mean_perf_cobra_na_impute <- res_indep_combalanced_me_cobra_na_impute[ , .(mean_perf = mean(meta_layer)), 
                                                                                                  by = .(perf_measure, effect)]
...
saveRDS(
  ...
  file = file.path(res_indep_me,
                   "res_indep_combalanced_me_mean_perf_cobra_na_impute.rds")
)
