...
reg_dep_mege_train_cobra_DT <- data.table::rbindlist(reg_dep_mege_train_cobra)
dep_mege_mean_perf_cobra <- reg_dep_mege_train_cobra_DT[ , .(mean_perf = mean(meta_layer)), 
