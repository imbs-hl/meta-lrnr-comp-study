...
reg_megepro_train_lr <- batchtools::loadRegistry(
  file.dir = file.path(reg_dep_methyl_genexpr_proexpr, "02-train-lr"), writeable = TRUE,
...
dep_megepro_mean_perf_lr <- reg_megepro_train_lr_DT[ , .(mean_perf = mean(meta_layer)), 
