...
## na_action = na_keep
## -----------------------------------------------------------------------------
reg_indep_missunbalanced_me_best_na_keep <- wrap_batchtools(reg_name = "02-train-best-na-keep",
...
## -----------------------------------------------------------------------------
##
reg_indep_missunbalanced_me_best_na_impute <- wrap_batchtools(reg_name = "02-train-best-na-impute",
                                                              work_dir = working_dir,
                                                              reg_dir = reg_indep_missunbalanced_me,
                                                              r_function = single_run_best,
                                                              vec_args = data.frame(
