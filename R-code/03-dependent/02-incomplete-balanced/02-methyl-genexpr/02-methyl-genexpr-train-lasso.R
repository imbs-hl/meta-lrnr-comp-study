...
dep_res_mege_lasso <- data.table::rbindlist(reg_dep_mege_train_lasso)
dep_mege_mean_perf_lasso <- dep_res_mege_lasso[ , .(mean_perf = mean(meta_layer)), 
                                                by = .(perf_measure, effect)]
print(dep_mege_mean_perf_lasso)
dep_res_mege_lasso$Setting <- "Dependent"
dep_res_mege_lasso$DE <- "DE: MeGe"
dep_res_mege_lasso$Meta_learner <- "Lasso"
saveRDS(object = dep_res_mege_lasso,
