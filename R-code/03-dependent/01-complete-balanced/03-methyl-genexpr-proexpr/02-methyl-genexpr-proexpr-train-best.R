...
dep_res_megepro_best <- data.table::rbindlist(reg_dep_megepro_train_best)
dep_megepro_mean_perf_best <- dep_res_megepro_best[ , .(mean_perf = mean(meta_layer)), 
                                                        by = .(perf_measure, effect)]
print(dep_megepro_mean_perf_best)
dep_res_megepro_best$Setting <- "Dependent"
dep_res_megepro_best$DE <- "DE: MeGePro"
dep_res_megepro_best$Meta_learner <- "BM"
saveRDS(object = dep_res_megepro_best,
