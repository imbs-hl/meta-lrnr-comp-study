indep_bs_all <- rbindlist(list(indep_me_bs, indep_mege_bs, indep_megepro_bs))
indep_bs_mean <- indep_bs_all[, .(BS = mean(meta_layer)),
                              by = c("Meta_learner", "Effect", "DE")]
indep_bs_mean[ , EXP := sprintf("Indep. & %s", DE)]
theme_set(
  theme_light()
)
...
# ============================
#
# dep_bs_all <- rbindlist(list(dep_bs_all,
#                              data.table(meta_layer = NA,
#                                         perf_measure = NA,
#                                         DE = "DE: Me",
#                                         Meta_learner = NA,
#                                         Effect = NA,
